...
urlpatterns = [
    ...
    path('fichier-pj-questionnaire/<int:pk>/',
    ...
    path('fichier-reponses-deposees/<int:pk>/',
         control_views.SendResponseFileList.as_view(),
         name='send-response-file-list'),
